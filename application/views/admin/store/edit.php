<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/edit/'.$store['r_id'];?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center mb-3">Chỉnh sửa thông tin nhà hàng"<?php echo $store['name'] ?>" chi tiết</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Tên nhà hàng</label>
                    <input type="text" name="res_name"  class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : '';?>" placeholder="Thêm tên nhà hàng"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label">Thời gian đóng cửa</label>
        ...
        <div class="form-actions">
            <input type="submit" name="submit" class="btn btn-success" value="Thực hiện thay đổi">
