<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/create_restaurant';?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center mb-3">Thêm chi tiết nhà hàng mới</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Tên nhà hàng</label>
                    <input type="text" name="res_name" id="rname" class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : '';?>" placeholder="Thêm ên nhà hàng"
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" placeholder=""
        ...
        <div class="form-actions">
            <input type="submit" id="btn" name="submit" class="btn btn-success" value="Lưu">
