<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit/'.$dish['d_id'];?>" method="POST"
        ...
        <h3 class="mb-3 text-center">Chỉnh sửa món ăn "<?php echo $dish['name']; ?>"</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Nhập tên món ăn" value="<?php echo set_value('name', $dish['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Nhập giá" value="<?php echo set_value('price', $dish['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Miêu tả" value="<?php echo set_value('about', $dish['about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="img">Hình ảnh đồ ăn</label>
                    <input type="file" id="image" name="image" placeholder="Nhập hình ảnh" class="form-control my-2
        ...
        <button type="submit" class="btn btn-primary ml-2">Thực hiện thay đổi</button>
...
const validate = () => {
    ...
    if (resnameVal === "--Chọn nhà hàng--") {
        setErrorMsg(resname, 'Chọn tên nhà hàng');
    } else {
        setSuccessMsg(resname);
    }
    if (dishnameVal === "") {
        setErrorMsg(dishname, 'Tên món ăn không được để trống');
    } else {
        setSuccessMsg(dishname);
    }
    if (priceVal === "") {
        setErrorMsg(price, 'Giá không được để trống');
    } else {
        setSuccessMsg(price);
    }
    if (aboutVal === "") {
