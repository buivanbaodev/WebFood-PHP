            ...
            <div class="card shadow p-30">
                <div class="media">
                    ...
                    <div class="media-body media-text-right">
                        ...
                        <p class="m-b-0">Danh sách hàng chờ</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow p-30">
                <div class="media">
                    ...
                    <div class="media-body media-text-right">
                        ...
                        <p class="m-b-0">Đơn đặt hàng bị từ chối</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <a href="<?php $id=1; echo base_url().'admin/home/generate_pdf/'.$id; ?>"
                        class="btn btn-success mt-3">Tải xuống báo cáo</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="row">
                ...
                <div class="col-md-12">
                    <a href="<?php $id=2; echo base_url().'admin/home/generate_pdf/'.$id; ?>"
                        class="btn btn-success mb-3">Tải xuống báo cáo</a>
                </div>
            </div>
        </div>
    </div>
