...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"><i class="fas fa-utensil-spoon"></i> MÓN ĂN NGON </a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'restaurant/index';?>">Nhà Hàng</a>
                    </li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'profile';?>"><i
                                    class="fas fa-user-circle"></i> Thông tin khách</a>
                            <hr>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url().'cart';?>"><i class="fas fa-cart-arrow-down"></i> Giỏ Hàng</a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
