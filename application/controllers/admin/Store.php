...
class Store extends CI_Controller {
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Đã thêm nhà hàng thành công');
    ...
    public function edit($id) {
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Không tìm thấy cửa hàng');
            redirect(base_url().'admin/store/index');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Đã cập nhật nhà hàng thành công');
                    redirect(base_url(). 'admin/store/index');
    ...
    public function delete($id){
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Không tìm thấy nhà hàng');
        ...
        $this->session->set_flashdata('res_success', 'Đã xóa nhà hàng thành công');
        redirect(base_url().'admin/store/index');
