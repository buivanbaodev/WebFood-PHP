...
class Menu extends CI_Controller {
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('dish_success', 'Menu đã được thêm thành công');
                ...
                $this->session->set_flashdata('dish_success', 'Món ăn đã được thêm thành công ');
                redirect(base_url(). 'admin/menu/index');
            }
    ...
    public function edit($id) {
        ...
        if(empty($dish)) {
            ...
            $this->session->set_flashdata('error', 'Không tìm thấy món ăn');
            redirect(base_url(). 'admin/menu/index');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                //nếu không có hình ảnh nào được chọn tự động thêm dữ liệu res mà không có hình ảnh
                $formArray['name'] = $this->input->post('name');
                $formArray['about'] = $this->input->post('about');
                $formArray['price'] = $this->input->post('price');
                $formArray['r_id'] = $this->input->post('rname');
                ...
                $this->session->set_flashdata('dish_success', 'Đã cập nhật món ăn thành công');
                redirect(base_url(). 'admin/menu/index');
            }
    ...
    public function delete($id){
        ...
        if(empty($dish)) {
            $this->session->set_flashdata('error', 'Món ăn không được tìm thấy');
        ...
        $this->session->set_flashdata('dish_success', 'Món ăn đã được xóa thành công');
        redirect(base_url().'admin/menu/index');
